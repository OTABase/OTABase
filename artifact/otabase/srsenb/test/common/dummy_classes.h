...
public:
  ...
  void notify_nas_oracle(uint16_t rnti) override {}
  bool is_mme_connected() override { return true; }
  bool send_nas_test_message(uint16_t rnti) override { return true; }
  bool send_paging_message(uint16_t rnti) override { return true; }
...
public:
  ...
  bool set_ready_for_test(uint16_t rnti, bool is_ready_for_test) override {return true;}
  bool set_reattach_timeout(uint16_t rnti, bool run_the_timer) override {return true;}
