...
int set_derived_args(all_args_t* args_, rrc_cfg_t* rrc_cfg_, phy_cfg_t* phy_cfg_, const srsran_cell_t& cell_cfg_)
{
  ...
  /* OTAFUZZ */
  rrc_cfg_->target_protocol = args_->general.target_protocol;
  rrc_cfg_->ota_conn_eval   = args_->general.ota_conn_eval;
  rrc_cfg_->output_directory_name = args_->general.output_directory_name;
  rrc_cfg_->replay_mode = args_->general.replay_mode;
  rrc_cfg_->temp_blacklist = args_->general.temp_blacklist;
  rrc_cfg_->test_device = args_->general.test_device;
