...
public:
  ...
  virtual void write_dl_info(uint16_t rnti, srsran::unique_byte_buffer_t sdu, bool is_id_req)    = 0;
  ...
  virtual void send_connection_release_tau(uint16_t rnti) = 0;
  virtual void send_connection_release_other(uint16_t rnti) = 0;
  virtual void send_next_test_msg(uint16_t rnti) = 0;
  virtual bool set_ready_for_test(uint16_t rnti, bool is_ready_for_test) = 0;
  virtual bool set_reattach_timeout(uint16_t rnti, bool run_the_timer) = 0;
};
